      ...
      >
        <v-card>
          ...
          >
            ...
            >mdi-circle</v-icon> Formulir Master Kelas BPJS
          </v-toolbar>
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/v2/master-data/kelas-bpjs",
      pagination: false,
      key: "id",
      title: "MASTER KELAS BPJS",
      subtitle: "Berikut Daftar Seluruh Kelas BPJS Yang Tersedia",
      breadcrumbs: [
        {
          text: "Master",
          disabled: true,
